export function init() {
	function client() {
		...
		function zb() {
			function e(a) { var b = a.lastIndexOf(r); if (b == -1) { b = a.length } var c = a.indexOf(s); if (c == -1) { c = a.length } var d = a.lastIndexOf(t, Math.min(c, b)); return d >= m ? a.substring(m, d + u) : l }
	...
	client(); (function() {
		var $gwt_version = "2.9.0"; var $wnd = window; var $doc = $wnd.document; var $moduleName, $moduleBase; var $stats = $wnd.__gwtStatsEvent ? function(a) { $wnd.__gwtStatsEvent(a) } : null; var $strongName = '41657B0D26E670272A853D8E149A0FE8'; function I() { }
		function _i() { }
		function Xi() { }
		function nc() { }
		function uc() { }
		...
		function _b(b, c) {
			Qb(); function d() { var a = GH(Yb)(b); a && $wnd.setTimeout(d, c) }
			$wnd.setTimeout(d, c)
		}
		...
		function Si(b, c, d, e) {
			Ri(); var f = Pi; $moduleName = c; $moduleBase = d; Mi = e; function g() { for (var a = 0; a < f.length; a++) { f[a]() } }
		...
		function Vi() {
			Ui = {}; !Array.isArray && (Array.isArray = function(a) { return Object.prototype.toString.call(a) === IH }); function b() { return (new Date).getTime() }
			!Date.now && (Date.now = b)
		}
		...
		function Kb(g) {
			Db(); function h(a, b, c, d, e) { if (!e) { e = a + ' (' + b + ':' + c; d && (e += ':' + d); e += ')' } var f = ib(e); Mb(f, false) }
