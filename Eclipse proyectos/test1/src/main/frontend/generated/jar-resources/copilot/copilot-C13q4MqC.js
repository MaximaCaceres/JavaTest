 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: fl, defineProperty: hl, getOwnPropertyDescriptor: vl, getOwnPropertyNames: pl, getOwnPropertySymbols: gl, getPrototypeOf: ml } = Object, hn = globalThis, $r = hn.trustedTypes, bl = $r ? $r.emptyScript : "", _l = hn.reactiveElementPolyfillSupport, dt = (e, t) => e, Mn = {
	toAttribute(e, t) {
		switch (t) {
			case Boolean:
				e = e ? bl : null;
...
let ze = class extends HTMLElement {
	...
	static getPropertyDescriptor(t, n, r) {
		const { get: i, set: o } = vl(this.prototype, t) ?? {
			get() {
				return this[n];
			}, set(a) {
				this[n] = a;
